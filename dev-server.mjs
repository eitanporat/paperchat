...
Per-Task prompt template (~1–2 KB, rich + specific):
...
>
> Target length: ~250 words. End with a callout: '<the exact pull-quote, written by you>'."
...
- Be terse. Wrap less-essential bits in \`<details class="pc-skip">\`.
