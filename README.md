...
> **Live demo:** [Chapter 3 — The Structure of Crystalline Solids][demo],
> an interactive chapter summary generated by paperchat from
> Callister & Rethwish's *Materials Science and Engineering*. See
> [Interactive chapter summaries](#interactive-chapter-summaries) below.
...
PDF — one section per concept, with web-component figures, KaTeX math,
3D unit cells, Anki-style flashcards, and clickable definitions for every
technical term. Output is plain HTML; runs without paperchat itself.
...
`pc-equation`, `pc-stepped`, `pc-anki`, `pc-grid`, …).
...
The chapter lands in `cc-workdir/chapter-<id>/` and can be hosted
anywhere static — the [live demo][demo] is exactly that output, served
